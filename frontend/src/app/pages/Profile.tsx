  ...
  const MENU_SECTIONS = [
    {
      ...
      items: [
        ...
        { icon: Package, label: 'Historique des Commandes', sub: 'Suivre et revoir vos achats passés', path: '/orders' },
      ...
      <div className="px-4 py-4 lg:max-w-[900px] lg:mx-auto lg:px-10 xl:px-0 lg:py-8 pb-28 lg:pb-8">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="rounded-2xl p-5 mb-5 relative overflow-hidden" style={{ background: CARD_BG, border: `1px solid ${BORDER}`, boxShadow: '0 4px 16px rgba(0,0,0,0.06)' }}>
          ...
          <div className="flex items-center gap-4 mb-5">
            ...
            <div>
              <h2 style={{ color: TEXT, fontWeight: 700, fontSize: '18px', marginBottom: '2px' }}>
                {currentUser?.name || 'Client Maison Marnoa'}
              </h2>
              ...
              <p style={{ color: MUTED, fontSize: '11px' }}>{currentUser?.email || 'client@maisonmarnoa.com'}</p>
            </div>
          </div>
